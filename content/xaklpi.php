    ...
    <style>
        * {
        ...
        .kelas-select select:hover {
            ...
            color: white; /* Pastikan teks tetap terlihat dengan warna putih */
        }
...
<body>
    <nav class="sidebar">
        <h2>menu absen</h2>
        <a href="#" class="sidebar-link"><i class="fas fa-home"></i> Menu Absen</a>
        <a href="#" class="sidebar-link"><i class="fas fa-user"></i> Data Absen</a>
        <a href="#" class="sidebar-link"><i class="fas fa-chart-bar"></i> Data Rekap</a>
        <a href="#" class="sidebar-link"><i class="fas fa-cog"></i> Pengaturan</a>
        <a href="#" class="sidebar-link"><i class="fas fa-sign-out-alt"></i> Keluar</a>
    </nav>
    
    <div class="main-content">
        <div class="header">
            <div>kelas <b><span id="current-class">X AKL putri</span></b> 👋</div>
    ...
    <script>
        ...
        // Menambahkan event listener untuk mengubah kelas aktif pada sidebar
